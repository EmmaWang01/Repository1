...
--disbursment transaction types used
*/
...
(
	...
	'{6089ea50-f311-4e49-a0e2-ee3a3929b957}',
	'{2cfef587-908c-48e9-8e5c-4d7788ab720c}',
	'{d537a6a6-6d8a-4801-8f22-b6dd26a56cbe}' -- transaction types included in cash out calculation
) and RTM_TypeGhost=0
;
with c as
(
...
and loan.[Cash Out] is not null


--select * from #DisbursmentTrans where RTM_IDLink_RMR=(select rmr_id from iO_Product_MasterReference where RMR_SeqNumber=2278702)
