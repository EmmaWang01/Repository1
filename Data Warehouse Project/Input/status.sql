...
-- get loan status
/*
select top 200 rmr.RMR_SeqNumber, xsu.XSU_Detail from iO_Product_MasterReference rmr
left join iO_Control_StatusMaster xsu on rmr.RMR_IDLink_XSU=xsu.XSU_ID
*/

if OBJECT_ID('tempdb..#TStatus') is not null
drop table #TStatus
...
select --top 10000 rmr.RMR_SeqNumber, xsu.StatusGroup, XSU_ID 
	distinct xsu.XSU_ID
from iO_Product_MasterReference rmr
left join #TStatus xsu on rmr.RMR_IDLink_XSU=xsu.XSU_ID
where xsu.StatusGroup='UNKNOWN'


select xsu_id, XSU_Detail from iO_Control_StatusMaster where XSU_ID in
(
	'{07d20963-5380-4e7f-9ffb-e6422c881d24}',
'{1277243f-c32c-484b-820b-7800a7fe1086}',
'{511bccd5-cea3-4fcb-bd46-08bc28811ef8}',
'{7d7f8e76-c07a-4560-8a4f-07e7262d3f73}',
'{849ba171-009c-46c5-bbac-5f80bcc7a692}',
'{8b768f27-daa8-40da-9642-080191f6016a}',
'{96c926c6-f899-4ed7-bcd6-ab3a96c817cc}',
'{9c71baec-ffc8-49f4-a65b-82d4a82a332c}',
'{abe014be-93bf-409e-ae0a-9e37668fc207}',
'{b4c26724-b0db-4178-b868-e0107a007739}',
'{bc79bd44-471d-4ff3-a703-215216e8da60}',
'{d5472c9f-bd22-4e96-87bd-81e909e51426}',
'{feaf1f29-c3ad-4552-ab46-c9e3e974f833}'
...
select top 200 rmr.RMR_SeqNumber, xsu.XSU_Detail from iO_Product_MasterReference rmr
left join iO_Control_StatusMaster xsu on rmr.RMR_IDLink_XSU=xsu.XSU_ID
where XSU_ID='{07d20963-5380-4e7f-9ffb-e6422c881d24}'
