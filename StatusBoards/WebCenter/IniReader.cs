...
// This file contains a number of classes that read from or write to special files.
namespace StatusBoard.Tools
{
    /// <summary>
    ...
    public class IniReader
    {
        ...
        public  string[] GetAllKeysInIniFileSection(string strSectionName, string strIniFileName)
        {
