...
select 
	...
	,Loans.RCD_CurrentStart as 'LodgeDate'
	...
	,RCD_Settle.RCD_CurrentStart as 'SettleDate'
...
left join io_product_controldate RCD_Settle on RCD_Settle.RCD_IDLink_RMR=Loans.rmr_id and RCD_Settle.RCD_Type=6
